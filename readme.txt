...
2. Type **Rock** in the search form and press the **Enter** key on your keyboard.
3. Click the **Activate** button to begin using Rock on your website.
...
Rock bundles the following third-party resources:
